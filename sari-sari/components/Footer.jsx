    ...
    <div className="container mx-auto px-10 mb-0">
      <div className="border-t w-full inline-block border-slate-200 py-6">
        <div className="md:float-left block">
          <a
            href="https://www.arthurlaroya.com"
            rel="noopener noreferrer"
            target="_blank"
          >
            <span className="sari-sari underline underline-offset-4 cursor-pointer font-black text-md text-white inline-flex gap-x-3 items-center hover:animate-pulse">
              © 2022 Arthur Laroya
              <br />
              all rights reserved
            </span>
