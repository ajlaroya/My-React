...
export default function Cart() {
  ...
  return (
    <div className="ml-4 flow-root text-sm lg:relative lg:ml-8">
      <button className="group -m-2 p-2 flex items-center" onClick={() => setOpen(!open)}>
        <ShoppingBagIcon
        ...
        >
          <div className="absolute inset-0 overflow-hidden">
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <Dialog.Overlay className="absolute inset-0 bg-neutral-900 backdrop-blur bg-opacity-75" />
            </Transition.Child>
            ...
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
              ...
              >
                <div className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll backdrop-blur bg-black/50 shadow-xl">
                    <div className="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                      <div className="flex items-start justify-between">
                        <Dialog.Title className="text-lg font-medium text-neutral-50">
                          {" "}
                          Shopping cart{" "}
                        </Dialog.Title>
                        <div className="ml-3 flex h-7 items-center">
                          <button
                            type="button"
                            className="-m-2 p-2 text-neutral-300 hover:text-gray-400"
                    ...
                    <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                      ...
                      <div className="mt-6 flex justify-center text-center text-sm text-neutral-100">
                        <p>
                          or{" "}
                          <button
                            type="button"
