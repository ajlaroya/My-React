  ...
  return (
    <div className="bg-white">
      <div className="relative sm:py-16">
        ...
        <div className="mx-auto max-w-md px-4 py-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
          <div className="relative rounded-2xl px-6 py-10 bg-pink-500 overflow-hidden shadow-xl sm:px-12 sm:py-20">
            ...
            <div className="relative">
              <div className="sm:text-center">
                ...
                <p className="mt-6 mx-auto max-w-2xl text-lg text-pink-100">
              ...
              <div className="flex items-center justify-center mt-12 space-x-6 sm:mt-12">
                <a
                  href="/"
                  className="text-white transition-colors duration-300 hover:text-pink-100"
                >
