...
const Footer = () => {
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="">
        ...
        <p>
          local flower shop based in little melb
        </p>
      </div>
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Flowers</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Pots</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-600">Plants</a>
        </p>
        <p>
          <a href="#!" className="text-gray-600">Guide</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
  ...
  <div className="text-center p-6">
    ...
    <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">arvoblooms 🌺</a>
  </div>
</footer>
  )
}
