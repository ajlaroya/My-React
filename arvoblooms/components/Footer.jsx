            ...
            <div className="md:max-w-md lg:col-span-2">
              ...
              <form className="flex flex-col mt-4 md:flex-row">
                <input
                  ...
                  required
                  type="text"
                  className="flex-grow w-full h-12 px-4 mb-3 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none md:mr-2 md:mb-0 focus:border-pink-400 focus:outline-none focus:shadow-outline"
                />
                <button
                  type="submit"
                  className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-tight transition duration-200 rounded shadow-md bg-pink-400 hover:bg-pink-500 text-white focus:shadow-outline focus:outline-none"
                >
                  Subscribe
                </button>
              </form>
