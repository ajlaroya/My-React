            ...
            <div className="mt-20">
              <div className="mt-6 sm:max-w-xl">
                <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">
                  Your new local florist
                </h1>
                <p className="mt-6 text-xl text-gray-500">
                dedicated to native blooms from all across Australia. We work with independent growers to source small batches of rare and diverse flowers. Plus the focus on Australian natives helps support biodiversity in farms around the country.
                </p>
              </div>
              <form action="#" className="mt-12 sm:max-w-lg sm:w-full sm:flex">
                <div className="min-w-0 flex-1">
                  ...
                  <input
                    ...
                    placeholder="Subscribe for announcements"
                  />
                </div>
                <div className="mt-4 sm:mt-0 sm:ml-3">
                  <button
                    type="submit"
                    className="block w-full rounded-md border border-transparent px-5 py-3 bg-pink-500 text-base font-medium text-white shadow hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 sm:px-10"
                  >
                    Notify me
                  </button>
                </div>
              ...
              <div className="mt-6">
                <div className="inline-flex items-center divide-x divide-gray-300">
                  ...
                  <div className="min-w-0 flex-1 pl-5 py-1 text-sm text-gray-500 sm:py-3">
                    ...
                    <span className="font-medium text-pink-600">120 customers</span>
                  </div>
                </div>
              </div>
            </div>
